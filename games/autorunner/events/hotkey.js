...
events.hotkey = function(key) {
  ...
  if (key === 1) {
    ...
    let sword = D.make("div", {
      style: `background-image: url('images/weapons/sword1.png'); width: ${board.size}px; height: ${board.size * 3}px; background-size: 100% 100%; position: absolute; z-index: 1; top: -105%;transition: all .1s linear; transform: rotate(-30deg);`
    })
