  ...
  let titleContent = Object.assign(document.createElement("span"), {
    ...
    onblur: function () {
      if (path[this.innerText] === undefined) {
        ...
        for (let i = 0; i < obj[targPath[targPath.length-1]]["__order"].length; i++) {
          if (obj[targPath[targPath.length-1]]["__order"][i] == oldItemName) {
            obj[targPath[targPath.length-1]]["__order"].splice(i, 1, itemName)
          }
        }
  ...
  let keyDelete = Object.assign(document.createElement("button"), {
    ...
    onclick: function () {
      let callback = function () {
        ...
        if (TS.refs.treeNav[TS.data.currentView[0]] === undefined) return;
  ...
  if (typeof(item) === "object") {
    if (item.object_root && item.object_root.type) {
      let div = TS.lib.createNode('div', {
        style: "text-align: center;display: inline-block; flex-grow: 1; align-self:center;"
      })
