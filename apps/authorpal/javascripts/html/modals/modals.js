    ...
    let item = TS.lib.createComponent({
      ...
      js: function ({box, root}) {
        ...
        setTimeout(function() {
          ...
          var myblob = new Blob([JSON.stringify(TS.data.local.files, 0, 2)], {
            type: "text/plain"
          });
          let url = URL.createObjectURL(myblob);
          let date = new Date();
          root.querySelector('#centerModal').innerHTML = `
          <b>Save a backup of data</b>
          <button id='exit'>X</button>
          <br>
          ...
          Left-click to save to downloads folder or right-click to choose location on harddrive to save to. <br>
