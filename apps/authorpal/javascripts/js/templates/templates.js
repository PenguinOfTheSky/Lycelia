    ...
    "book outline": function () {
      let obj = {
        ...
        "general": {
          ...
          "premise": TS.js.templates.html5['rich text'](),
          "genre(s)": TS.js.templates.html5['rich text'](),
          "zeitgeist": TS.js.templates.html5['rich text'](),
          "Brainstorm/Random notes": TS.js.templates.html5['rich text']()
        },
        "#advanced": {
          "*head": {
            object_root: {
